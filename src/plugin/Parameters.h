...
inline constexpr std::array<ParameterSpec, 93> kParameters{{
  ...
  {ParameterId::ReverbEnabled, "reverb.enabled", "Reverb", "", 0., 1., 0., Mapping::Linear},
  ...
  {ParameterId::ArpEnabled, "arp.enabled", "Arpeggiator", "", 0., 1., 0., Mapping::Linear},
  {ParameterId::ArpMode, "arp.mode", "Arp Mode", "", 0., 4., 0., Mapping::Linear},
  {ParameterId::ArpRate, "arp.rate", "Arp Rate", "", 0., 7., 2., Mapping::Linear},
  {ParameterId::ArpGate, "arp.gate", "Gate", "%", 5., 100., 80., Mapping::Linear},
  {ParameterId::ArpOctaves, "arp.octaves", "Octaves", "", 1., 4., 1., Mapping::Linear},
