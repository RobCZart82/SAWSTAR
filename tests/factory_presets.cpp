...
int main(){
 ...
 for(size_t p=0;p<presets.size();++p){const auto& v=presets[p].values;
  ...
  for(float sr:{44100.f,48000.f,96000.f}){
   ...
   s.SetFilter(v[8],v[9],v[10]);s.SetFilterEnvelope(v[11],v[12],v[13],v[14],v[15],v[16]);s.SetPerformance(v[17],v[18]);s.SetOutputBoost(v[19]);s.SetMixer(v[20],v[21],v[22],v[23],v[24],v[25],v[26],v[30]);s.SetOsc2(v[27],v[28],v[29]);s.SetFilterCharacter(v[31],v[32]);
