...
int main(){using namespace sawstar;
 ...
 mailbox.Publish(1,0,100);check(mailbox.Clipped(0,5099)&&!mailbox.Clipped(0,5100));
 mailbox.Publish(1,0,4000);check(mailbox.Clipped(0,8999)&&!mailbox.Clipped(0,9000));
 mailbox.ClearClip(0);check(!mailbox.Clipped(0,4001));
 mailbox.Publish(1,0,0xfffffff0u);check(mailbox.Clipped(0,100));check(!mailbox.Clipped(0,6000));
